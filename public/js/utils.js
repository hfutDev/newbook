...
//							alert(data)
	...
	$(".sort-li-wrap").hover(function(){ // 导航栏分类显影
		...
		$(".sortBy-college").find("ul").css({display:"block",top:"-2px",left:parseInt(_wrap.width())}).find("li:odd").css({background:"#ede7db"})
		$(".sortBy-lable").find("ul")[0].style.display="none";
		$(".sortBy-category").find("ul")[0].style.display="none";
		$(".BBoard")[1].style.display="none";
		$(".BBoard")[2].style.display="none";
		$(".BBoard")[0].style.display="block";
		_wrap.mouseover(function(){
			...
			$(".BBoard")[0].style.display="block";
			$(".sortBy-college").mouseover(function(){
				$(".BBoard")[0].style.display="block";
				$(".BBoard")[1].style.display="none";
				$(".BBoard")[2].style.display="none";
				$(".sortBy-category").find("ul").css({display:"none"});
				$(".sortBy-lable").find("ul").css({display:"none"});
				$(this).find("ul").css({display:"block",top:"-2px",left:parseInt(_wrap.width())}).find("li:odd").css({background:"#ede7db"})
				return false;
			});
			$(".sortBy-category").mouseover(function(){
				...
				$(".sortBy-lable").find("ul").css({display:"none"});
				$(this).find("ul").css({display:"block",top:"32px",left:parseInt(_wrap.width())}).find("li:odd").css({background:"#ede7db"})
				return false;
			});
			$(".sortBy-lable").mouseover(function(){
				...
				$(".BBoard")[0].style.display="none";
				$(".BBoard")[1].style.display="none";
				$(".BBoard")[2].style.display="block";
				$(".sortBy-college").find("ul").css({display:"none"});
				$(".sortBy-category").find("ul").css({display:"none"});
				$(this).find("ul").css({display:"block",top:"62px",left:parseInt(_wrap.width())}).find("li:odd").css({background:"#ede7db"})
				return false;
			});
		});
	},function(){
