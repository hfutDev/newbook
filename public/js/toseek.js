...
$(function () {
    ...
    $('#press').bind('blur', {
        condition: 'press',
        text: "出版社",
        reg_text: "出版社必须由不多于20个非字母字符组成",
        regExp: bookname_reg
    }, regCheck);
    $('#bookname').bind('blur', {
        condition: 'bookname',
        text: "书名",
        reg_text: "书名必须由不多于20个非字母字符组成",
        regExp: bookname_reg
    }, regCheck);
    $('#original-price').bind('blur', {
        condition: 'ori_price',
        text: "原价",
        reg_text: "原价须是小于1000整数或保留一位小数",
        regExp: price_reg,
        aimat: false
    }, regCheck);
    $('#going-price').bind('blur', {
        condition: 'go_price',
        text: "现价",
        reg_text: "现价须是小于1000整数或保留一位小数",
        regExp: price_reg,
        aimat: false
    }, regCheck);
